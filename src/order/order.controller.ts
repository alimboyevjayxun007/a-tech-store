...
export class OrderController {
  ...
  @Roles(Role.Admin, Role.SuperAdmin) // Faqat adminlar barcha buyurtmalarni ko'ra oladi
  @ApiBearerAuth('accessToken')
  ...
  @HttpCode(HttpStatus.OK)
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles(Role.Admin, Role.SuperAdmin) // Faqat adminlar buyurtma holatini yangilay oladi
  @ApiBearerAuth('accessToken')
  ...
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles(Role.Admin, Role.SuperAdmin) // Faqat adminlar buyurtmalarni o'chira oladi
  @ApiBearerAuth('accessToken')
